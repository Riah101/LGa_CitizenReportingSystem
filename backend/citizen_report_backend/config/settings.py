"""
Sauti ya Raia - Django Settings
Citizen Complaint & Escalation Platform
"""
...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='citizen_report_db'),
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Sauti ya Raia API',
    'DESCRIPTION': 'Tanzania Citizen Complaint & Escalation Platform API',
    'VERSION': '1.0.0',
    ...
    'TAGS': [
        ...
        {'name': 'complaints', 'description': 'Complaint CRUD & escalation'},
        {'name': 'notifications', 'description': 'User notifications'},
        {'name': 'stats', 'description': 'Statistics & analytics'},
    ],
}

# ─── Celery (Background Tasks / Auto-Escalation) ──────────────────────────────
...
DEFAULT_FROM_EMAIL = 'Sauti ya Raia <noreply@sautiyaraia.go.tz>'
...
# ─── Africa's Talking (SMS/OTP for Tanzania) ──────────────────────────────────
